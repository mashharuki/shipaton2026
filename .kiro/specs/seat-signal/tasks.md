...
- [ ] 1. 共有基盤: frontend / backend 共通コードの確立
- [ ] 1.1 共通エラー処理・Result・ユーティリティの共有パッケージを作成する
...
- [ ] 1.2 API・データセット・分析イベントの契約スキーマを定義する
...
- [ ] 1.4 GitHub Actions の CI パイプラインを構築する
