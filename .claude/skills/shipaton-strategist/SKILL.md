...
1. ユーザーの経験・ドメイン知識から「本人が語れる本物の課題」を掘り起こす（想像上の課題は敗因の筆頭）。2026年は日本からの参加登録が前年の約5倍・グローバル全体の半数以上という報告があり（`references/rules-and-categories.md` の「日本からの参加動向」参照）、定番テーマは競合が厚くなりやすい前提で差別化を強めに意識する
